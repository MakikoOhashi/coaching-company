...
const COPY = {
  ja: {
    ...
    companyViewIntro: "会社がいまどのように判断を回しているかを表示します。",
    companyLoopTitle: "Autonomous Loop",
    companyMissionTitle: "Current Mission",
    companyFeedTitle: "Live Feed",
    companyDecisionBreakdownTitle: "Decision Breakdown",
    companyAdaptationTitle: "Policy Adaptation",
    companyNextMoveTitle: "Next Move",
    companyMissionMode: "現在のモード",
    companyMissionReview: "現在のレビュー",
    companyMissionCase: "選択中の案件",
    ...
    companyYes: "必要",
    companyRiskBar: "Risk",
    companyPassBar: "Pass Probability",
    companyLoadBar: "Load",
    companyFeedQueue: "Review Queue",
    companyFeedSystem: "System",
    companyFeedCeo: "CEO",
    companyFeedCoach: "Coach A",
    companyConclusion: "Conclusion",
    companyLoopStatus: "Loop Status",
    companyLoopPolicy: "policy",
    companyLoopExecution: "execution",
    companyLoopEvaluation: "evaluation",
    companyLoopRedecision: "re-decision",
    companyStableLoop: "stable loop",
    companyImproving: "improving",
    companyAdaptationReason: "Reason",
    companyRiskHigh: "high",
    companyRiskMedium: "medium",
    companyRiskLow: "low",
  },
  en: {
    ...
    companyViewIntro: "This shows how the company is currently running its decision loop.",
    companyLoopTitle: "Autonomous Loop",
    companyMissionTitle: "Current Mission",
    companyFeedTitle: "Live Feed",
    companyDecisionBreakdownTitle: "Decision Breakdown",
    companyAdaptationTitle: "Policy Adaptation",
    companyNextMoveTitle: "Next Move",
    companyMissionMode: "Current mode",
    companyMissionReview: "Current review",
    companyMissionCase: "Selected case",
