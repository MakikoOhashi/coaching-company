...
const COPY = {
  ja: {
    ...
    companyViewIntro: "この学習セッションの裏側で、会社全体がどう動いているかと、現在の案件を表示します。",
    companyOrgTitle: "会社組織",
    companySnapshot: "選択中の学習者案件",
    companyRoleCeo: "CEO",
    companyRoleCoachA: "Coach A",
    companyRoleCoachB: "Coach B",
    companyRoleQueue: "Review Queue",
    companyRoleSummary: "Company Summary",
    ...
    companyNo: "不要",
    companyYes: "必要",
    companyOrgCeoBody: "今日の方針判断と、例外ケースの戦略レビューを担当",
    companyOrgCoachABody: "学習者Aを担当。導入問題から本題までの伴走を実行中",
    companyOrgCoachBBody: "学習者Bを担当。誤答後の補助と follow-up を実行中",
    companyOrgQueueBody: "daily review / coach escalation / monthly review の案件を確認",
    companyOrgSummaryBody: "今日の重点科目、リスク、進め方の全体傾向を整理",
  },
  en: {
    ...
    companyViewIntro: "This shows how the company is operating as a whole behind the learning session, plus the current learner case.",
    companyOrgTitle: "Company Structure",
    companySnapshot: "Selected learner case",
    companyRoleCeo: "CEO",
    companyRoleCoachA: "Coach A",
    companyRoleCoachB: "Coach B",
    companyRoleQueue: "Review Queue",
    ...
    companyYes: "Needed",
    companyOrgCeoBody: "Owns today's strategic decisions and exception reviews",
    companyOrgCoachABody: "Handles learner A and runs the guided study flow",
    companyOrgCoachBBody: "Handles learner B and runs follow-up after mistakes",
    companyOrgQueueBody: "Tracks daily review, coach escalation, and monthly review cases",
    companyOrgSummaryBody: "Keeps today's subject priorities, risk, and pacing aligned",
  },
};
