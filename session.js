...
const COPY = {
  ja: {
    ...
    skipAhead: "すぐ進む",
    loading: "読み込み中です...",
    companyViewTitle: "Company Control Room",
    companyViewIntro: "今日の会社判断と、その伝達状況を表示します。",
    companyNowLabel: "NOW",
    companyNowLine: "CEO は 4件で keep current plan を維持し、1件は人間確認へ上げています。System は high-risk signal を監視中です。",
    companyNowApproved: "人間確認で CEO 判断が承認されました。現在は active cases 全体の監視を継続しています。",
    companyNowReturned: "人間確認から AI queue へ差し戻されました。CEO が次の判断を再評価しています。",
    companyCommandTitle: "Command Map",
    companyHealthTitle: "Company Health",
    companyDecisionsTitle: "Decisions",
    companyTransmissionTitle: "Decision Transmission",
    companyEscalationTitle: "Human Escalation",
    companyHealthStatus: "Company Health",
    companyHealthActive: "Active Cases",
    companyHealthRisk: "High Risk",
    companyHealthEscalations: "Escalations",
    companyHealthTrend: "Trend",
    companyDecisionKeep: "KEEP CURRENT PLAN",
    companyDecisionAdjust: "ADJUST LOAD",
    companyDecisionEscalate: "ESCALATE",
    companyQueueTitle: "Review Queue",
    companyQueueValue: (daily, monthly) => `daily ${daily} / monthly ${monthly}`,
    companyQueueMeta: "reports feeding the CEO",
    companyLoopPolicyTitle: "CEO",
    companyLoopPolicyMeta: "confidence: high / scope: 4 cases",
    companyCoachALabel: "Coach A",
    companyCoachBLabel: "Coach B",
    companyCoachCLabel: "Coach C",
    companyCoachCases: (count) => `${count} cases`,
    companyCoachApplied: "applied",
    companyCoachMonitoring: "monitoring",
    companyCoachWaiting: "waiting",
    companyCoachEscalated: "escalated",
    companyStableLoop: "stable",
    companyImproving: "adaptive",
    companyTransmissionDecision: "CEO Decision",
    companyTransmissionOps: "Operational Translation",
    companyTransmissionInstruction: "Coach Instruction",
    companyTransmissionDecisionValue: "keep current plan",
    companyTransmissionOpsValue: "recovery mode / reduced load",
    companyTransmissionInstructionValue: "light session execution / monitor comprehension",
    companyEscalationCount: "Human Review Required",
    companyEscalationReason: "Reason",
    companyEscalationReasonValue: "unstable comprehension pattern",
    companyEscalationStatus: "Status",
    companyEscalationWaiting: "waiting for human input",
    companyEscalationApproved: "approved by human reviewer",
    companyEscalationReturned: "returned to AI queue",
    companyEscalationApprove: "Approve",
    companyEscalationReturn: "Return",
    companyRefresh: "更新する",
    companyBack: "学習画面へ戻る",
    companyTrendRiskUp: "High Risk ↑ slight",
    companyTrendPassStable: "Pass Probability → stable",
    companyFlowKeep: "issued policy: keep current plan",
    companyFlowAdjust: "applied: recovery mode / reduced load",
    companyFlowMonitor: "monitoring: risk + comprehension",
    companyFlowNoEscalation: "no escalation",
    companyHealthWatch: "WATCH ↑",
    companyHealthStable: "STABLE →",
  },
  en: {
    ...
    loading: "Loading...",
    companyViewTitle: "Company Control Room",
    companyViewIntro: "This shows today's company decisions and how they are being transmitted.",
    companyNowLabel: "NOW",
    companyNowLine: "CEO is maintaining keep current plan across 4 cases, with 1 case under human review. The system is monitoring high-risk signals.",
    companyNowApproved: "The CEO decision has been approved by human review. Monitoring continues across active cases.",
    companyNowReturned: "The case has been returned to the AI queue from human review. The CEO is re-evaluating the next action.",
    companyCommandTitle: "Command Map",
    companyHealthTitle: "Company Health",
    companyDecisionsTitle: "Decisions",
    companyTransmissionTitle: "Decision Transmission",
